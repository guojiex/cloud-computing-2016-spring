...
import jiexing.cmu.edu.cc.project22.AwsVMController;
...
public class LoadBalancer {
    public class startANewDC implements Runnable {
        ...
        private void initDC() throws Exception {
            ...
            // vc.createDataCenter(resourceGroupName, resourceGroupName.trim(),
            // "cc15619p22dcv6-osDisk.b0c453f3-f75f-4a2d-bd9c-ae055b830124.vhd",
            // "Standard_A1", subscriptionID,
            // storageAccount);
            HashMap<String, String> temp = vc.createDataCenter("ami-6f486605", "project2.2", "", "", "m3.medium", "");
    ...
    private void checkHealth() throws IOException {
        for (int i = 0; i < instances.length; i++) {
            ...
            if (checkHealth(i)) {// health
                if(this.instanceStatus[i]==-1){
                    System.out.println("dc start success.");
                }
