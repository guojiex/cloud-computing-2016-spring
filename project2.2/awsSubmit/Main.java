...
public class Main {
	...
	static {
		...
		instances[0] = new DataCenterInstance("First", "http://ec2-54-164-33-93.compute-1.amazonaws.com");
		instances[1] = new DataCenterInstance("Second", "http://ec2-52-90-14-255.compute-1.amazonaws.com");
		instances[2] = new DataCenterInstance("Third", "http://ec2-52-3-254-24.compute-1.amazonaws.com");
	}
