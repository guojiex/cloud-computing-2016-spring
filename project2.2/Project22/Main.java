...
public class Main {
	...
	static {
		...
		instances[0] = new DataCenterInstance("First", "http://dc-561820d0.eastus.cloudapp.azure.com");
		instances[1] = new DataCenterInstance("Second", "http://dc-274705d1.eastus.cloudapp.azure.com");
		instances[2] = new DataCenterInstance("Third", "http://dc-177268d2.eastus.cloudapp.azure.com");
	}
