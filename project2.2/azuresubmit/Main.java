...
public class Main {
	...
	static {
		...
		instances[0] = new DataCenterInstance("First", "http://dc-53985d0.eastus.cloudapp.azure.com");
		instances[1] = new DataCenterInstance("Second", "http://dc-384508d1.eastus.cloudapp.azure.com");
		instances[2] = new DataCenterInstance("Third", "http://dc-121812d2.eastus.cloudapp.azure.com");
	}
