...
public class AwsVMController implements VmController {
    ...
    private int loadBalancerNumber = 1;
     ...
     * @see com.amazonaws.auth.Prop/Us  ertiesCredentials
    ...
    public HashMap<String, String> createVM(String amiName, String securityGroupName, String vmName,
        ...
        runInstancesRequest.withImageId(amiName).withInstanceType(instanceSize).withMinCount(1).withMaxCount(1)
                .withSecurityGroups(securityGroupName).withKeyName("myKeyPair");
    ...
    /**
     * Get the DNS of specific instance by instance id
     * 
     * @param instanceId
     * @return null if not running. HashMap with key "DNS" and DNS as value as
     *         return.
    ...
    public static void main(String[] args) throws Exception {
        // new AwsVMController().createVM("ami-8ac4e9e0", "project2.1",
        // "testVM", "", "m3.medium", "", "");
    }

    @Override
    public HashMap<String, String> createLoadBalancer(String amiName, String securityGroupName, String vmName,
            String sourceVhdUri, String instanceSize, String subscriptionId) throws Exception {
        vmName = String.format("lb%d", loadBalancerNumber);
        loadBalancerNumber++;
        return this.createVM(amiName, securityGroupName, vmName, "", instanceSize, "", "");
    }
