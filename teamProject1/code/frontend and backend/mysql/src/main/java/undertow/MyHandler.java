...
public class MyHandler implements HttpHandler {
     ...
     */
    public MyHandler() throws MalformedURLException, ClassNotFoundException, SQLException {
        super();
        requester = new MysqlRequesterDoubleTable("localhost");
    }

    MysqlRequesterDoubleTable requester = null;
