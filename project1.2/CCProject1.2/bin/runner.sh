...
answer_2() {
    sort -n -k 1 -k 2r output | head -n 1 | awk '{print $2"\t"$1}'
...
# to standard output
answer_3() {
    #awk -F"\t" '{print $2,$20}' output | sort -t: -n -r -k 2 | head -n 1  | awk -F":| " '{print $1"\t"$3}'
...
answer_4() {
    #grep '\t20151201:0\t' output | awk -F"\t" '{print $1,$2}' | sort -n -k 1r | head -n 1 | awk '{print $2}'
    # Write a function to get the answer to Q4. Do not just echo the answer.
    javac Answer4.java
    java Answer4 | sort -n -k 2r | head -n 1 |  awk '{print $1}'
}
...
answer_6() {
    ...
    #done < q6
    javac Answer6.java
    javac Answer6_2.java
    java Answer6 | sort -t$'\t' -k 2nr -k 1 > temp.txt
    java Answer6_2
...
answer_7() {
    ...
    javac Answer7.java
    javac Answer6_2.java
    java Answer7 | sort -t$'\t' -k 2nr -k 1r > temp.txt
    java Answer6_2
}
